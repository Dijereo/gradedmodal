...
macro_rules! sat_and {
    ($frame:expr, $formula:expr, $clsr:expr, $default:expr, $toh:expr) => {{
        match $frame {
            ...
            FrameCondition::KB | FrameCondition::DB => time_sat!($clsr, Calculus::sat::<TransitB<false>>, $frame, $formula, $toh),
            FrameCondition::TB => time_sat!($clsr, Calculus::sat::<TransitB<true>>, $frame, $formula, $toh),
